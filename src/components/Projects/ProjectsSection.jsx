  ...
  const projects = [
    {
      ...
      demoPic: data.reNetworkPic.childImageSharp.fluid,
    },
    {
      ...
      demoPic: data.ypSwapPic.childImageSharp.fluid,
    },
    {
      ...
      demoPic: data.foodBlogPic.childImageSharp.fluid,
    },
    {
      ...
      demoPic: data.blockchainExplorerPic.childImageSharp.fluid,
    },
    {
      ...
      demoPic: data.tuditpmPic.childImageSharp.fluid,
    },
    {
      name: "Gorillas Game",
      description:
      ...
      demoPic: data.gorillasPic.childImageSharp.fluid,
    },
    {
      name: "Magic Mirror",
      description:
      ...
      demoPic: data.magicMirrorPic.childImageSharp.fluid,
    },
  ]
